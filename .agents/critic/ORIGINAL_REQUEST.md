...
4. Write adversarial test cases (Tier 5) in a new file `tests/test_adversarial_2.py`. Enforce that all tests use pytest's `tmp_path` or mock objects to prevent mutative writes to the codebase.
