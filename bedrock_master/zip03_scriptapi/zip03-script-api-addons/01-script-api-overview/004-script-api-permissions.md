# Script API Permissions

> **Categoria**: Zip03 Script Api Addons | **Subcategoria**: 01 Script Api Overview
> **Documento**: #160 | **Gerado**: 2026-06-25

---

## Visão Geral

Este documento cobre aspectos técnicos de **Script API Permissions** dentro da arquitetura Bedrock Server Mods.

## Conceitos Fundamentais

- **Conceito Principal**: Script API Permissions é fundamental para o ecossistema de modding Bedrock.
