# @minecraft/server-ui Overview

> **Categoria**: Zip03 Script Api Addons | **Subcategoria**: 03 Minecraft Server Ui
> **Documento**: #181 | **Gerado**: 2026-06-25

---

## Visão Geral

Este documento cobre aspectos técnicos de **@minecraft/server-ui Overview** dentro da arquitetura Bedrock Server Mods.

## Conceitos Fundamentais

- **Conceito Principal**: @minecraft/server-ui Overview é fundamental para o ecossistema de modding Bedrock.
