...
> **Documento**: #1325 | **Gerado**: 2026-06-25

---

## Visão Geral

Este documento cobre aspectos técnicos de **Script API Docs** dentro da arquitetura Bedrock Server Mods.

## Conceitos Fundamentais

- **Conceito Principal**: Script API Docs é fundamental para o ecossistema de modding Bedrock.
