...
> **Documento**: #1194 | **Gerado**: 2026-06-25

---

## Visão Geral

Este documento cobre aspectos técnicos de **PMMP Plugin API** dentro da arquitetura Bedrock Server Mods.

## Conceitos Fundamentais

- **Conceito Principal**: PMMP Plugin API é fundamental para o ecossistema de modding Bedrock.
