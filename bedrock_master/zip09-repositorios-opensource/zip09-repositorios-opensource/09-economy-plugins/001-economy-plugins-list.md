# Economy Plugins List

> **Categoria**: Zip09 Repositorios Opensource | **Subcategoria**: 09 Economy Plugins
> **Documento**: #1273 | **Gerado**: 2026-06-25

---

## Visão Geral

Este documento cobre aspectos técnicos de **Economy Plugins List** dentro da arquitetura Bedrock Server Mods.

## Conceitos Fundamentais

- **Conceito Principal**: Economy Plugins List é fundamental para o ecossistema de modding Bedrock.
