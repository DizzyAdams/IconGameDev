# LegacyScriptEngine Repo

> **Categoria**: Zip09 Repositorios Opensource | **Subcategoria**: 01 Core Loaders
> **Documento**: #1180 | **Gerado**: 2026-06-25

---

## Visão Geral

Este documento cobre aspectos técnicos de **LegacyScriptEngine Repo** dentro da arquitetura Bedrock Server Mods.

## Conceitos Fundamentais

- **Conceito Principal**: LegacyScriptEngine Repo é fundamental para o ecossistema de modding Bedrock.
