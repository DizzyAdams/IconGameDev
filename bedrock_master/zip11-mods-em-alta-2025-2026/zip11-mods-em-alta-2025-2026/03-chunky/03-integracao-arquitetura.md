# Integração com Arquitetura - Chunky - Pré-geração de Chunks

> **Downloads**: 300k+ | **Stars/GitHub**: 292
> **Stack**: Java / Bedrock Script API
> **Repositório**: https://github.com/pop4959/Chunky
...
Pre-genera chunks para eliminar lag de geração em tempo real. Essencial para servidores grandes.

## Features Principais

- Pré-geração de chunks
- Shape selection (circle, square, worldborder)
- Progress tracking
- Pause/resume
- Low priority para não lagar servidor
