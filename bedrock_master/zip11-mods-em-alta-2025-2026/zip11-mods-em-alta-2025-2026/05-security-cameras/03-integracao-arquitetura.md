# Integração com Arquitetura - Security Cameras Addon

> **Downloads**: 729k+ | **Stars/GitHub**: N/A (Addon)
> **Stack**: Behavior Pack + Resource Pack + Script API
> **Repositório**: Marketplace / MCPEDL
...
Adiciona câmeras de segurança funcionais ao Bedrock. Visualização remota via monitor blocks.
