# Integração com Arquitetura - TACZ - Timeless and Classics Zero

> **Downloads**: 724k+ | **Stars/GitHub**: N/A (Addon)
...
Framework de armas para Bedrock com 100+ armas, attachments, e sistema de ballistics.

## Features Principais

- 100+ armas
- Sistema de attachments
- Ballistics realistas
- Scopes funcionais
- Recoil patterns
- Custom ammo
