# Integração com Arquitetura - Silk Touch Spawners

> **Downloads**: 1.5M+ | **Stars/GitHub**: N/A (Addon)
...
Permite quebrar spawners com Silk Touch para coletar e reposicionar. 1.5M downloads.

## Features Principais

- Silk Touch em spawners
- Spawners dropam como item
- Mantém tipo de mob
- Crafting de spawners
- Spawner upgrades
