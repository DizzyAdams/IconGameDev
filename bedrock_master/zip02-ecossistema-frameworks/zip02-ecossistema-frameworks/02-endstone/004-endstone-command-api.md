# Endstone Command API

> **Categoria**: Zip02 Ecossistema Frameworks | **Subcategoria**: 02 Endstone
> **Documento**: #88 | **Gerado**: 2026-06-25

---

## Visão Geral

Este documento cobre aspectos técnicos de **Endstone Command API** dentro da arquitetura Bedrock Server Mods.

## Conceitos Fundamentais

- **Conceito Principal**: Endstone Command API é fundamental para o ecossistema de modding Bedrock.
