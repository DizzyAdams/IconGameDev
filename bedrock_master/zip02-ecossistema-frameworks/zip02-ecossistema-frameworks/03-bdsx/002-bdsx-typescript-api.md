...
> **Documento**: #98 | **Gerado**: 2026-06-25

---

## Visão Geral

Este documento cobre aspectos técnicos de **BDSX TypeScript API** dentro da arquitetura Bedrock Server Mods.

## Conceitos Fundamentais

- **Conceito Principal**: BDSX TypeScript API é fundamental para o ecossistema de modding Bedrock.
