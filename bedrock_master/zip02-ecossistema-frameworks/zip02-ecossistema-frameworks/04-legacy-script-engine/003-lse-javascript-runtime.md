# LSE JavaScript Runtime

> **Categoria**: Zip02 Ecossistema Frameworks | **Subcategoria**: 04 Legacy Script Engine
> **Documento**: #111 | **Gerado**: 2026-06-25

---

## Visão Geral

Este documento cobre aspectos técnicos de **LSE JavaScript Runtime** dentro da arquitetura Bedrock Server Mods.

## Conceitos Fundamentais

- **Conceito Principal**: LSE JavaScript Runtime é fundamental para o ecossistema de modding Bedrock.
