# @minecraft/server-net Overview

> **Categoria**: Zip03 Script Api Addons | **Subcategoria**: 04 Minecraft Server Net
> **Documento**: #193 | **Gerado**: 2026-06-25

---

## Visão Geral

Este documento cobre aspectos técnicos de **@minecraft/server-net Overview** dentro da arquitetura Bedrock Server Mods.

## Conceitos Fundamentais

- **Conceito Principal**: @minecraft/server-net Overview é fundamental para o ecossistema de modding Bedrock.
