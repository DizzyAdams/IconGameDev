...
> **Documento**: #173 | **Gerado**: 2026-06-25

---

## Visão Geral

Este documento cobre aspectos técnicos de **Dimension API** dentro da arquitetura Bedrock Server Mods.

## Conceitos Fundamentais

- **Conceito Principal**: Dimension API é fundamental para o ecossistema de modding Bedrock.
