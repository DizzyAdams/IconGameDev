# Script API Performance

> **Categoria**: Zip03 Script Api Addons | **Subcategoria**: 01 Script Api Overview
> **Documento**: #162 | **Gerado**: 2026-06-25

---

## Visão Geral

Este documento cobre aspectos técnicos de **Script API Performance** dentro da arquitetura Bedrock Server Mods.

## Conceitos Fundamentais

- **Conceito Principal**: Script API Performance é fundamental para o ecossistema de modding Bedrock.
