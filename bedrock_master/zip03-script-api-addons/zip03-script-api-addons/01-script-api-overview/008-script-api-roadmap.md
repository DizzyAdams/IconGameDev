...
> **Documento**: #164 | **Gerado**: 2026-06-25

---

## Visão Geral

Este documento cobre aspectos técnicos de **Script API Roadmap** dentro da arquitetura Bedrock Server Mods.

## Conceitos Fundamentais

- **Conceito Principal**: Script API Roadmap é fundamental para o ecossistema de modding Bedrock.
