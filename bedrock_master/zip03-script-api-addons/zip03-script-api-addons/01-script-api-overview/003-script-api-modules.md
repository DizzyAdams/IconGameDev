...
> **Documento**: #159 | **Gerado**: 2026-06-25

---

## Visão Geral

Este documento cobre aspectos técnicos de **Script API Modules** dentro da arquitetura Bedrock Server Mods.

## Conceitos Fundamentais

- **Conceito Principal**: Script API Modules é fundamental para o ecossistema de modding Bedrock.
