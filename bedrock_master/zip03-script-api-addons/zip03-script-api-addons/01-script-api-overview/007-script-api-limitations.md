# Script API Limitations

> **Categoria**: Zip03 Script Api Addons | **Subcategoria**: 01 Script Api Overview
> **Documento**: #163 | **Gerado**: 2026-06-25

---

## Visão Geral

Este documento cobre aspectos técnicos de **Script API Limitations** dentro da arquitetura Bedrock Server Mods.

## Conceitos Fundamentais

- **Conceito Principal**: Script API Limitations é fundamental para o ecossistema de modding Bedrock.
