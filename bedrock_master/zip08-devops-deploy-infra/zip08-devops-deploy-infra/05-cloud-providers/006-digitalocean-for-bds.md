# DigitalOcean for BDS

> **Categoria**: Zip08 Devops Deploy Infra | **Subcategoria**: 05 Cloud Providers
> **Documento**: #1050 | **Gerado**: 2026-06-25

---

## Visão Geral

Este documento cobre aspectos técnicos de **DigitalOcean for BDS** dentro da arquitetura Bedrock Server Mods.

## Conceitos Fundamentais

- **Conceito Principal**: DigitalOcean for BDS é fundamental para o ecossistema de modding Bedrock.
