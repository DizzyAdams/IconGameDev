# LSE Plugin Migration

> **Categoria**: Zip02 Ecossistema Frameworks | **Subcategoria**: 04 Legacy Script Engine
> **Documento**: #114 | **Gerado**: 2026-06-25

---

## Visão Geral

Este documento cobre aspectos técnicos de **LSE Plugin Migration** dentro da arquitetura Bedrock Server Mods.

## Conceitos Fundamentais

- **Conceito Principal**: LSE Plugin Migration é fundamental para o ecossistema de modding Bedrock.
