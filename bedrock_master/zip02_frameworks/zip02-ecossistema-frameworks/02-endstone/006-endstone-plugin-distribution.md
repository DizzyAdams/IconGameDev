# Endstone Plugin Distribution

> **Categoria**: Zip02 Ecossistema Frameworks | **Subcategoria**: 02 Endstone
> **Documento**: #90 | **Gerado**: 2026-06-25

---

## Visão Geral

Este documento cobre aspectos técnicos de **Endstone Plugin Distribution** dentro da arquitetura Bedrock Server Mods.

## Conceitos Fundamentais

- **Conceito Principal**: Endstone Plugin Distribution é fundamental para o ecossistema de modding Bedrock.
