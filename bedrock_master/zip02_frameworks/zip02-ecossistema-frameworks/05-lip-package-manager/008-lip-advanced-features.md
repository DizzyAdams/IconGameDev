# lip Advanced Features

> **Categoria**: Zip02 Ecossistema Frameworks | **Subcategoria**: 05 Lip Package Manager
> **Documento**: #128 | **Gerado**: 2026-06-25

---

## Visão Geral

Este documento cobre aspectos técnicos de **lip Advanced Features** dentro da arquitetura Bedrock Server Mods.

## Conceitos Fundamentais

- **Conceito Principal**: lip Advanced Features é fundamental para o ecossistema de modding Bedrock.
