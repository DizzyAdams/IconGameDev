# Extra Document 1 - 01 Agent Architecture
...
Este documento cobre aspectos técnicos de **Extra Document 1 - 01 Agent Architecture** dentro da arquitetura Bedrock Server Mods.

## Conceitos Fundamentais

- **Conceito Principal**: Extra Document 1 - 01 Agent Architecture é fundamental para o ecossistema de modding Bedrock.
