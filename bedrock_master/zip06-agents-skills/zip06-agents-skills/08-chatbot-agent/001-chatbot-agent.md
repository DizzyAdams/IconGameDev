...
> **Documento**: #721 | **Gerado**: 2026-06-25

---

## Visão Geral

Este documento cobre aspectos técnicos de **Chatbot Agent** dentro da arquitetura Bedrock Server Mods.

## Conceitos Fundamentais

- **Conceito Principal**: Chatbot Agent é fundamental para o ecossistema de modding Bedrock.
