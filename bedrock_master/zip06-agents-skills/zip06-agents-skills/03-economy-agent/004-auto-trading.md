...
> **Documento**: #664 | **Gerado**: 2026-06-25

---

## Visão Geral

Este documento cobre aspectos técnicos de **Auto-Trading** dentro da arquitetura Bedrock Server Mods.

## Conceitos Fundamentais

- **Conceito Principal**: Auto-Trading é fundamental para o ecossistema de modding Bedrock.
