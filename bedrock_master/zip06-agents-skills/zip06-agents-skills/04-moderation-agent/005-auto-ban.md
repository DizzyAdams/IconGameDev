...
> **Documento**: #677 | **Gerado**: 2026-06-25

---

## Visão Geral

Este documento cobre aspectos técnicos de **Auto-Ban** dentro da arquitetura Bedrock Server Mods.

## Conceitos Fundamentais

- **Conceito Principal**: Auto-Ban é fundamental para o ecossistema de modding Bedrock.
