...
> **Documento**: #798 | **Gerado**: 2026-06-25

---

## Visão Geral

Este documento cobre aspectos técnicos de **MCP Prompts** dentro da arquitetura Bedrock Server Mods.

## Conceitos Fundamentais

- **Conceito Principal**: MCP Prompts é fundamental para o ecossistema de modding Bedrock.
