...
> **Documento**: #796 | **Gerado**: 2026-06-25

---

## Visão Geral

Este documento cobre aspectos técnicos de **MCP Tools** dentro da arquitetura Bedrock Server Mods.

## Conceitos Fundamentais

- **Conceito Principal**: MCP Tools é fundamental para o ecossistema de modding Bedrock.
