# Extra Document 1 - 02 Core Agent
...
Este documento cobre aspectos técnicos de **Extra Document 1 - 02 Core Agent** dentro da arquitetura Bedrock Server Mods.

## Conceitos Fundamentais

- **Conceito Principal**: Extra Document 1 - 02 Core Agent é fundamental para o ecossistema de modding Bedrock.
