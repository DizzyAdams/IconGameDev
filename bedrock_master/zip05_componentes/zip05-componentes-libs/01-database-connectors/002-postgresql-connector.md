...
> **Documento**: #458 | **Gerado**: 2026-06-25

---

## Visão Geral

Este documento cobre aspectos técnicos de **PostgreSQL Connector** dentro da arquitetura Bedrock Server Mods.

## Conceitos Fundamentais

- **Conceito Principal**: PostgreSQL Connector é fundamental para o ecossistema de modding Bedrock.
