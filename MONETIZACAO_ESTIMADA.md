...
- Target: 50 maps @ $2.99-$9.99
- Receita potencial: $149-$499 por mapa
- Epic 12% cut
...
- Epic: $15,000/ano (estimativa conservadora)
- **Total: ~$308,000/ano**

## Meta Operacional: US$ 40k/mês (cenário escalado, aprovado)

Para bater ~US$ 40k/mês recorrente após aprovação, o motor já construído
...
| Epic/Fortnite | ~US$ 10k | 50→200 maps (scaffold Epic no roadmap) |
| **Total** | **~US$ 40k/mês** | pipeline `submit/pipeline.py` envia os 4 canais |
